...
class GeoPoint {
    ...
    isEqual(other) {
        return (this === other ||
            (is_1.default.instanceof(other, GeoPoint) && this.latitude === other.latitude &&
...
class DocumentSnapshot {
    ...
    static fromUpdateMap(ref, data) {
        ...
        function merge(target, value, path, pos) {
            ...
            if (!is_1.default.defined(target[key])) {
                if (isLast) {
                    if (value instanceof FieldTransform) {
                        ...
                        return !is_1.default.empty(target) ? target : null;
                    }
                    // The merge is done.
                ...
                assert_1.default(!isLast, 'Can\'t merge current value into a nested object');
    ...
    data() {
        ...
        if (is_1.default.undefined(fields)) {
            return undefined;
        }
        let obj = {};
    ...
    protoField(field) {
        ...
        let components = path_1.FieldPath.fromArgument(field).toArray();
    ...
    _decodeValue(proto) {
        ...
        switch (valueType) {
            ...
            case 'referenceValue': {
                return new DocumentReference(this.ref.firestore, path_1.ResourcePath.fromSlashSeparatedString(proto.referenceValue));
            }
            case 'arrayValue': {
                let array = [];
     ...
     */
    get isEmpty() {
        return is_1.default.undefined(this._fieldsProto) || is_1.default.empty(this._fieldsProto);
    }
    /**
    ...
    isEqual(other) {
        ...
        return (this === other ||
            (is_1.default.instance(other, DocumentSnapshot) &&
                this._ref.isEqual(other._ref) &&
                deep_equal_1.default(this._fieldsProto, other._fieldsProto, { strict: true })));
    }
    /**
    ...
    static encodeValue(val) {
        ...
        if (is_1.default.instance(val, timestamp_1.Timestamp)) {
            return {
                timestampValue: { seconds: val.seconds, nanos: val.nanoseconds },
            };
        }
        if (is_1.default.date(val)) {
            let timestamp = timestamp_1.Timestamp.fromDate(val);
            return {
                timestampValue: {
        ...
        if (is_1.default.nil(val)) {
            return {
                nullValue: 'NULL_VALUE',
            };
        }
        if (is_1.default.instance(val, DocumentReference) || is_1.default.instance(val, path_1.ResourcePath)) {
            return {
                referenceValue: val.formattedName,
            };
        }
        if (is_1.default.instance(val, GeoPoint)) {
            return {
                geoPointValue: val.toProto(),
            };
        }
        if (is_1.default.instanceof(val, Buffer) || is_1.default.instanceof(val, Uint8Array)) {
            return {
                bytesValue: val,
            };
        }
...
class QueryDocumentSnapshot extends DocumentSnapshot {
    ...
    data() {
        let data = super.data();
        assert_1.default(is_1.default.defined(data), 'The data in a QueryDocumentSnapshot should always exist.');
        return data;
    }
}
/**
...
class DocumentSnapshotBuilder {
     ...
     */
    build() {
        assert_1.default(is_1.default.defined(this.fieldsProto) === is_1.default.defined(this.createTime), 'Create time should be set iff document exists.');
        assert_1.default(is_1.default.defined(this.fieldsProto) === is_1.default.defined(this.updateTime), 'Update time should be set iff document exists.');
        ...
        const applyDocumentMask = data => {
            ...
            const processObject = (currentData, currentPath) => {
                ...
                Object.keys(currentData).forEach(key => {
                    ...
                    else if (is_1.default.object(currentData[key])) {
...
class Precondition {
    ...
    toProto() {
        ...
        let proto = {};
        if (is_1.default.defined(this._lastUpdateTime)) {
...
function validateFieldValue(val, options, depth) {
    ...
    else if (is_1.default.instanceof(val, DocumentReference)) {
        return true;
    }
    else if (is_1.default.instanceof(val, GeoPoint)) {
        return true;
    }
...
function validatePrecondition(precondition, allowExist) {
    if (!is_1.default.object(precondition)) {
        throw new Error('Input is not an object.');
    }
    let conditions = 0;
    if (is_1.default.defined(precondition.exists)) {
        ++conditions;
        if (!allowExist) {
            throw new Error('"exists" is not an allowed condition.');
        }
        if (!is_1.default.boolean(precondition.exists)) {
            throw new Error('"exists" is not a boolean.');
        }
    }
    if (is_1.default.defined(precondition.lastUpdateTime)) {
        ++conditions;
        if (!is_1.default.instance(precondition.lastUpdateTime, timestamp_1.Timestamp)) {
...
function validateSetOptions(options) {
    ...
    if (is_1.default.defined(options.merge) && !is_1.default.boolean(options.merge)) {
        throw new Error('"merge" is not a boolean.');
    }
    if (is_1.default.defined(options.mergeFields)) {
        if (!is_1.default.array(options.mergeFields)) {
    ...
    if (is_1.default.defined(options.merge) && is_1.default.defined(options.mergeFields)) {
...
function documentPkg(DocumentRefType) {
    DocumentReference = DocumentRefType;
    validate = validate_1.validatePkg({
        FieldPath: path_1.FieldPath.validateFieldPath,
        PlainObject: isPlainObject,
    });
    const fieldValue = field_value_1.fieldValuePkg(DocumentSnapshot);
