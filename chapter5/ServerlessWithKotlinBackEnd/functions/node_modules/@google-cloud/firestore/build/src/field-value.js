...
const validate = validate_1.validatePkg({});
...
class ArrayUnionTransform extends FieldTransform {
    ...
    toProto(fieldPath) {
        const encodedElements = DocumentSnapshot.encodeValue(this.elements).arrayValue;
        return {
            fieldPath: fieldPath.formattedName,
