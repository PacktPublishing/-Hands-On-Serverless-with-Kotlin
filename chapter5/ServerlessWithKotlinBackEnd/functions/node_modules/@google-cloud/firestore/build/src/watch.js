        ...
        stream
            ...
            if (proto.targetChange) {
                ...
                if (changed) {
                    ...
                    snapshot.ref = new DocumentReference(self._firestore, path_1.ResourcePath.fromSlashSeparatedString(name));
...
function watchPkg(FirestoreType, DocumentChangeType, DocumentReferenceType, DocumentSnapshotType) {
