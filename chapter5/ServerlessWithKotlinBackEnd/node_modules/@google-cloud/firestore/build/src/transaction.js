...
class Transaction {
    ...
    get(refOrQuery) {
        ...
        if (is_1.default.instance(refOrQuery, DocumentReference)) {
        ...
        if (is_1.default.instance(refOrQuery, Query)) {
...
function transactionPkg(FirestoreType) {
    let reference = reference_1.referencePkg(FirestoreType);
...
exports.transactionPkg = transactionPkg;
