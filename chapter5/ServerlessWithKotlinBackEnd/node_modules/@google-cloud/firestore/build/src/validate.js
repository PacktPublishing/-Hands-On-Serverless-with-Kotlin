 ...
 */
function validatePkg(validators) {
    validators = Object.assign({
        function: is_1.default.function,
        integer: (value, min, max) => {
            min = is_1.default.defined(min) ? min : -Infinity;
            max = is_1.default.defined(max) ? max : Infinity;
        ...
        number: (value, min, max) => {
            min = is_1.default.defined(min) ? min : -Infinity;
            max = is_1.default.defined(max) ? max : Infinity;
            if (!is_1.default.number(value) || is_1.default.nan(value)) {
                return false;
            }
            if (value < min || value > max) {
                throw new Error(`Value must be within [${min}, ${max}] inclusive, but was: ${value}`);
        ...
        object: is_1.default.object,
        string: is_1.default.string,
        boolean: is_1.default.boolean
    }, validators);
    let exports = {};
    let register = type => {
        ...
        exports[`is${camelCase}`] = function (argumentName, value) {
            let valid = false;
            let message = is_1.default.number(argumentName) ?
    ...
    exports.customObjectError = val => {
        if (is_1.default.object(val) && val.constructor.name !== 'Object') {
