...
const libVersion = require(pkg_up_1.default.sync(__dirname)).version;
...
class Firestore {
    ...
    snapshot_(documentOrName, readTime, encoding) {
        ...
        if (is_1.default.string(documentOrName)) {
            document.ref = new DocumentReference(this, path_1.ResourcePath.fromSlashSeparatedString(documentOrName));
        }
        else {
            document.ref = new DocumentReference(this, path_1.ResourcePath.fromSlashSeparatedString(documentOrName.name));
...
const reference = reference_1.referencePkg(Firestore);
CollectionReference = reference.CollectionReference;
DocumentReference = reference.DocumentReference;
const document = document_1.documentPkg(DocumentReference);
...
const batch = write_batch_1.writeBatchPkg(Firestore, DocumentReference);
WriteBatch = batch.WriteBatch;
Transaction = transaction_1.transactionPkg(Firestore);
FieldValue = field_value_1.fieldValuePkg(DocumentSnapshot).FieldValue;
/**
